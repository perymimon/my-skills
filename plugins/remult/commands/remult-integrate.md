---
description: Remult integration patterns — withRemult context, Express custom routes, multer uploads, Telegraf bot, and data providers.
argument-hint: [topic]
---
...
If `$ARGUMENTS` is provided, focus only on that topic (e.g. "multer", "telegraf", "data provider"). Otherwise cover the full reference.
